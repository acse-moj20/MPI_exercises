...
// Notes:
	// request variable has the inofrmation about a particular communication 
	// since we have a communication that is not copleting yet.
	// this section only sets up the communication. It doesnt wait for the communication to be completed.
	// it is only after the wait all that we can check that all communications have been completed.
	// You cant also reuse the variable that is being sent while in the communications set up. You can only re use it after the wait. 
	// It is perfectly acceptable to mix and match a blocking send/receive with a non-blocking send/receive.
